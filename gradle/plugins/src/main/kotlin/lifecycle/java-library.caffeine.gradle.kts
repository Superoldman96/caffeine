...
tasks.withType<JavaCompile>().configureEach {
  ...
  options.apply {
    ...
    var failOnWarnings = isCI()
    compilerArgumentProviders.add(object : CommandLineArgumentProvider {
      override fun asArguments() = if (failOnWarnings.get()) listOf("-Werror") else emptyList()
    })
    encoding = "UTF-8"
  }
}
